...
session_start();
     ...
     $sql = "SELECT user_name,user_id,email FROM users where acnt_type='admin'";
     ...
     if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['del_acnt'])){
          ...
          if(mysqli_num_rows($result4) != 0) {
               ...
               if (mysqli_query($con, $sql)) {
                    $errortxt =  "Record deleted successfully. Please refresh the page.. ";
               }else{ $errortxt = "some error";  }
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="container">
         ...
         <div class="logincontainer">
              <p align=center>Click once upon the <span style="color:#2bcaff"> admin number</span> to copy</p>
          <table border=2px class="styled-table">
               ...
               <br><br>
               <h3>Enter the ID of the Admin to delete record </h3>
               <input type="text" name="del_id" required  />
               <input type="submit" name="del_acnt" class="btn btn-primary" value="Delete">
               <label for="error_msg" style="color:red;"><?php echo $errortxt = $errortxt; ?></label>
