...
session_start();
     ...
     $sql = "SELECT eno,job_title,job_num,job_details,location,salary,job_type,qualifications,last_date FROM jobs where eno='$eno'";
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li class="active"><a href="yjobs.php">Your Jobs</a></li>
    ...
    <div class="container">
          ...
          <form class="formcontainer" method="POST">
               ...
               <p style="color:blue;">Caution! Once you delete jobs, you wont be able to view the aspirants to that job you deleted.</p>     
          </form>
     </div>
 </div>
   <!-- FOOTER -->
