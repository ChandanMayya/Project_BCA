...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <div class="imgcontainer">
                  <img src="images/mail4.png" alt="Avatar" class="avatar">
                </div>
                <h2 style="text-align:center;">Mailer</h2>
                <div style="padding-left:270px;">
                <a href="mail/newjob.php"><div class="square">
                ...
                <br> New <br> Jobs</h3>
                  ...
                  <a href="mail/newaspirant.php"><div class="square">
                  <h3><i class="fa fa-industry" aria-hidden="true"></i>
                  <br> New <br> Aspirants </h3>
                  </a> 
             </div>

                    <a href="mail/feedbackreply.php"><div class="square">
                    <h3><i class="fa fa-briefcase" aria-hidden="true"></i>
                    <br> View <br> Feedbacks </h3>
                    </a> 
               </div>
</div>
